...
void GameApp::UpdateScene(float dt)
{
    ...
    if (ImGui::Begin("Lighting"))
    {
        ...
        // 添加纹理旋转控件
        ImGui::SliderFloat("Texture Rotation", &m_textureRotation, 0.0f, 360.0f);
    }
    ImGui::End();
    ImGui::Render();
...
void GameApp::DrawScene()
{
    ...
    // 绑定纹理和采样器
    m_pd3dImmediateContext->PSSetShaderResources(0, 1, m_pTecture.GetAddressOf());
...
bool GameApp::InitResource()
{
    ...
    // 加载纹理
    HR(CreateDDSTextureFromFile(m_pd3dDevice.Get(), L"D:\\Code\\QG\\DX11\\Project6\\Texture\\WoodCrate.dds", nullptr, m_pTecture.GetAddressOf()));
